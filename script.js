    ...
    result.forEach((character) => {
        ...
        function houseHogwarts(house){
            if(house.toLowerCase() == "hufflepuff"){
                document.getElementById('house').src = "image/Hufflepuff.png"

            }else if(house.toLowerCase() == "gryffindor"){
                document.getElementById('house').src = "image/Gryffindor.png"

            }else if(house.toLowerCase() == "ravenclaw"){
                document.getElementById('house').src =  "image/Ravenclaw.png"

            }else if(house.toLowerCase() == "slytherin"){
                document.getElementById('house').src = "image/Slytherin.png"
